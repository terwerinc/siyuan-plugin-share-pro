...
## 更新摘要
**所做更改**
- 新增了跳过文档的跟踪和反馈机制，包括批量处理中的跳过计数和进度更新
- 改进了进度计算逻辑，排除跳过的文档以提供更准确的进度显示
...
**图表来源**
- [src/service/ShareService.ts:40-1181](file://src/service/ShareService.ts#L40-L1181)
...
## 架构总览
下图展示了从调用入口到后端服务的数据流与职责划分，包括新增的增量分享功能和跳过文档的跟踪机制。
