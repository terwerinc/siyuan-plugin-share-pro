...
## 更新摘要
**所做更改**
- 新增了docTreeHierarchy属性到sPost对象，增强了文档树层次结构的处理和存储能力
- 改进了增量分享检测机制：移除了convertSiyuanDateToTimestamp工具函数的使用，改用更直接的Date构造函数
- 改进了日期字段处理，保留原始创建和修改时间戳
...
- 性能优化（分页获取、并发控制）
- 与API层的交互模式与数据流转
- **新增** 增强的文档树层次结构处理：docTreeHierarchy属性支持更完整的文档树信息传递
...
- **新增docTreeHierarchy属性**：在buildSharePost方法中添加了docTreeHierarchy属性的复制，增强了文档树层次结构的处理和存储能力
- **完整的文档树信息**：docTreeHierarchy属性支持更完整的文档树信息传递，包括文档的层级关系和结构信息
- **与现有属性协同**：docTreeHierarchy与现有的docTree和docTreeLevel属性协同工作，提供更丰富的文档树可视化支持
- **性能优化**：直接复制原始属性值，避免了额外的转换和处理开销

这种增强使得分享服务能够更好地处理复杂的文档树结构，为用户提供更准确的文档层次展示。
...
- **新增** 文档树层次结构优化：docTreeHierarchy属性的直接复制避免了额外的转换开销，提升文档树处理性能。
...
- **新增** 文档树层次结构问题
  - docTreeHierarchy属性缺失：检查buildSharePost方法中是否正确复制该属性
  - 文档树显示异常：确认docTreeHierarchy属性的完整性和正确性
...
**新增** 增强的文档树层次结构处理能力为复杂文档树的分享提供了更好的支持，docTreeHierarchy属性的引入使得文档树信息能够完整传递，为用户提供更准确的文档层次展示。
...
- **新增** 文档树层次结构处理
  - docTreeHierarchy属性自动复制，支持完整的文档树信息传递
  - 与docTree和docTreeLevel属性协同工作，提供丰富的文档树可视化支持
