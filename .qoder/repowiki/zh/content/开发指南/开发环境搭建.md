...
- 包管理器：项目使用 pnpm 作为包管理器，版本在 package.json 中声明为 pnpm@10.32.1。请确保全局安装 pnpm 并使用项目指定版本。
...
## 结论
通过以上配置与流程，开发者可以快速搭建并维护思源笔记分享专业版的开发环境。建议在团队内统一 pnpm 版本与 Node.js 版本，规范 IDE 插件与代码风格，确保开发效率与质量。
